...
------------ | ------------- | ------------- | -------------
**key** | **string** | Object key clients should upload to | [optional] [default to undefined]
**url** | **string** | Presigned URL to PUT the file body to directly | [optional] [default to undefined]
**method** | **string** | HTTP method the client must use against &#x60;url&#x60; (always PUT - the object storage backend does not implement a POST-based upload API) | [optional] [default to undefined]
