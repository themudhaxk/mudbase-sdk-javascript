...
**signupEndpoint** | **string** |  | [optional] [default to undefined]
...
**defaultPermissions** | **Array&lt;object&gt;** |  | [optional] [default to undefined]
**collectionPermissions** | [**{ [key: string]: CreateRoleRequestCollectionPermissionsValue; }**](CreateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (same as POST add role). | [optional] [default to undefined]
...
```typescript
import { UpdateProjectRoleRequest } from 'mudbase-sdk';

const instance: UpdateProjectRoleRequest = {
    name,
    description,
    signupEndpoint,
    requiresApproval,
